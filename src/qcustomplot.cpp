  ...
  mCachedMargin(0)
{
  ...
  lowerRange=-1000000;//mRange.minRange;
  upperRange=1000000;//mRange.maxRange;
}
...
void QCPAxis::setRange(const QCPRange &range)
{
  ...
  if (newRange.lower<lowerRange){newRange.lower=lowerRange;}
  if (newRange.upper>upperRange){newRange.upper=upperRange;}
  if (mScaleType == stLogarithmic)
  {
...
void QCPAxis::setLowerUpperRange(double lower, double upper)
{
    lowerRange=lower;
    upperRange=upper;
    QCPRange temp=mRange;
    QCPRange temp1=temp;
    temp1.upper=temp1.upper+6;
    setRange(temp1);
    setRange(temp);
}
...
void QCPAxis::setRange(double lower, double upper)
{
  ...
  if (lower<lowerRange){lower=lowerRange;}
  if (upper>upperRange){upper=upperRange;}
  mRange.lower = lower;
  mRange.upper = upper;
  if (mScaleType == stLogarithmic)
  {
